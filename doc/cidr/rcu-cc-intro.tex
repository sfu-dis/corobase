...
Therefore, we focus on the performance of non-partitioning-based engines.
...
\secref{eval} underlines some weaknesses of a representative of the new breed of memory-optimized shared-everything transaction processing systems; and \secref{conclusion} concludes.

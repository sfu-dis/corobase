...
\def\thepapertitle{RIA: An architecture for fast OLTP without compromises} 
\def\thepaperkeywords{RCU, Indirection array, OLTP, Concurrency control}
...
\input{rcu-cc-abstract}
\input{rcu-cc-intro}
\input{rcu-cc-design}
\input{rcu-cc-eval}
\input{rcu-cc-related}
\input{rcu-cc-conclusions}

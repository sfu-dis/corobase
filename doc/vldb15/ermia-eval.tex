...
We use the Stock table of TPC-C database (24 warehouses) for the microbenchmark transactions. The Stock table has 100K*Warehouses (2.4M) records. Each transaction randomly picks a subset of records to read and a smaller fraction of those to update.

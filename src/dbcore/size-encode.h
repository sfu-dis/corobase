 ...
 */
uint8_t encode_size_aligned(size_t &sz, size_t align_bits=DEFAULT_ALIGNMENT_BITS);
...
static inline
size_t
decode_size_aligned(uint8_t code, size_t align_bits=DEFAULT_ALIGNMENT_BITS)
{

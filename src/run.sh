...
# new query mix
numactl --interleave=all $1 --verbose --bench tpce --scale-factor 500 --num-threads $2 --runtime $3 --pin-cpu --numa-memory 30G -o "--egen-dir ./benchmarks/egen/flat/egen_flat_in --customers 5000 --working-days 10 --workload-mix="4.9,13,1,8,9,8,10.1,10,14,2,20""
